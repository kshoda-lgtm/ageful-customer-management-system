...
import type {
  ...
  MaintenanceResponse, PeriodicMaintenance, Attachment
} from '../types'
...
const initContracts: Contract[] = [
  {
    ...
    land_cost_monthly: null, insurance_fee: null, other_fee: null, transfer_account: null,
    ...
    maintenance_start_date: '2020-01-01', notes: '清水電気448,800・新電660,000円',
    created_at: '2020-01-01',
  },
  {
    id: 2, project_id: 2, billing_method: '請求書', billing_due_day: '6月25日',
    ...
    maintenance_start_date: '2022-06-25', notes: null,
  ...
  },
  {
    ...
    maintenance_start_date: null, notes: null,
    created_at: '2021-10-27',
  },
  {
    id: 4, project_id: 4, billing_method: '請求書', billing_due_day: '12月1日',
  ...
  },
  {
    ...
    billing_amount_ex: 150000, billing_amount_inc: 165000,
    annual_maintenance_ex: 150000, annual_maintenance_inc: 165000,
    land_cost_monthly: 1000000, insurance_fee: null, other_fee: null, transfer_account: null,
    subcontractor: '九徳', subcontract_fee_ex: null, subcontract_fee_inc: 105600,
    subcontract_billing_day: null, subcontract_start_date: '2022-01-14',
    maintenance_start_date: '2022-01-14', notes: null,
    created_at: '2022-01-14',
  },
  {
    id: 8, project_id: 8, billing_method: '請求書', billing_due_day: '2月26日',
    billing_amount_ex: null, billing_amount_inc: null,
    ...
    subcontract_billing_day: null, subcontract_start_date: null,
    maintenance_start_date: null, notes: '年間110,000円',
...
const initAnnualRecords: AnnualRecord[] = [
  // 阿久根（contract_id:1）
  { id: 1, contract_id: 1, year: 2023, billing_date: '2023-02-01', received_date: '2023-02-01', maintenance_record: null, escort_record: null, status: '入金済' },
  { id: 2, contract_id: 1, year: 2024, billing_date: '2024-01-05', received_date: '2024-01-08', maintenance_record: null, escort_record: null, status: '入金済' },
  { id: 3, contract_id: 1, year: 2025, billing_date: null, received_date: null, maintenance_record: null, escort_record: null, status: '未入金' },
  { id: 4, contract_id: 1, year: 2026, billing_date: null, received_date: '2026-02-01', maintenance_record: null, escort_record: null, status: '入金済' },
  // 幡ヶ岳（contract_id:2）
  { id: 5, contract_id: 2, year: 2023, billing_date: '2023-07-25', received_date: '2023-07-25', maintenance_record: '2023.7.4枯草・報告書', escort_record: null, status: '入金済' },
  { id: 6, contract_id: 2, year: 2024, billing_date: '2024-07-10', received_date: '2024-05-07', maintenance_record: '2024.07.06除草・報告書', escort_record: null, status: '入金済' },
  { id: 7, contract_id: 2, year: 2025, billing_date: null, received_date: '2025-05-07', maintenance_record: '2025.09.17除草・報告書', escort_record: '2025.07.06除草・報告書', status: '入金済' },
  { id: 8, contract_id: 2, year: 2026, billing_date: null, received_date: null, maintenance_record: null, escort_record: null, status: '未入金' },
  // 天草8666（contract_id:3）
  { id: 9, contract_id: 3, year: 2023, billing_date: '2023-10-06', received_date: '2023-11-01', maintenance_record: null, escort_record: null, status: '入金済' },
  { id: 10, contract_id: 3, year: 2024, billing_date: '2024-07-02', received_date: '2024-07-29', maintenance_record: null, escort_record: null, status: '入金済' },
  { id: 11, contract_id: 3, year: 2025, billing_date: null, received_date: '2025-06-03', maintenance_record: '2025.09.17除草・報告書', escort_record: null, status: '入金済' },
  { id: 12, contract_id: 3, year: 2026, billing_date: null, received_date: null, maintenance_record: null, escort_record: null, status: '未入金' },
  // 竹田市梅木水引（contract_id:4）
  { id: 13, contract_id: 4, year: 2023, billing_date: '2023-12-01', received_date: '2023-12-27', maintenance_record: '2023.7.4枯草・報告書', escort_record: null, status: '入金済' },
  { id: 14, contract_id: 4, year: 2024, billing_date: '2024-03-02', received_date: '2024-05-17', maintenance_record: '2024.5.17除草・報告書', escort_record: null, status: '入金済' },
  { id: 15, contract_id: 4, year: 2025, billing_date: null, received_date: '2025-05-01', maintenance_record: '2025.09.17除草・報告書', escort_record: '2025.07.06除草・報告書', status: '入金済' },
  { id: 16, contract_id: 4, year: 2026, billing_date: null, received_date: null, maintenance_record: null, escort_record: null, status: '未入金' },
  // 三好市奥公（contract_id:6）
  { id: 17, contract_id: 6, year: 2022, billing_date: null, received_date: '2022-09-29', maintenance_record: null, escort_record: null, status: '入金済' },
  { id: 18, contract_id: 6, year: 2023, billing_date: '2023-06-08', received_date: '2023-06-21', maintenance_record: '2023.6.8枯草', escort_record: null, status: '入金済' },
  { id: 19, contract_id: 6, year: 2024, billing_date: '2024-05-07', received_date: '2024-05-30', maintenance_record: '2024.5.17除草・報告書', escort_record: '2025.2.8特検', status: '入金済' },
  { id: 20, contract_id: 6, year: 2025, billing_date: null, received_date: '2025-05-01', maintenance_record: '2025.09.02除草・報告書', escort_record: null, status: '入金済' },
  { id: 21, contract_id: 6, year: 2026, billing_date: '2026-03-09', received_date: null, maintenance_record: null, escort_record: null, status: '請求済' },
  // 淡路市心谷1（contract_id:7）
  { id: 22, contract_id: 7, year: 2023, billing_date: '2023-01-31', received_date: '2023-01-31', maintenance_record: null, escort_record: '12/28保守代入金済', status: '入金済' },
  { id: 23, contract_id: 7, year: 2024, billing_date: '2024-01-06', received_date: '2024-01-26', maintenance_record: '2025.06.20・08.06除草・報告書', escort_record: null, status: '入金済' },
  { id: 24, contract_id: 7, year: 2025, billing_date: null, received_date: null, maintenance_record: null, escort_record: null, status: '未入金' },
  { id: 25, contract_id: 7, year: 2026, billing_date: null, received_date: null, maintenance_record: null, escort_record: null, status: '未入金' },
]
...
const initMaintenanceResponses: MaintenanceResponse[] = [
  ...
  { id: 14, response_no: '25-A', project_id: 6, status: '対応中', inquiry_date: '2026-01-24', occurrence_date: '2026-01-24', target_area: 'パワコン', situation: '1/24・2/2アラートメールあり\nセンサー1の発電量少ない', response_content: '2/3イシハソーラー窓口氏へ駆付依頼\nエラーコード:A22・製造 No.S029111\n12/25に停止', report: '2/6再起動にて復旧・社長にメールで報告済', created_at: '2026-01-24' },
  { id: 15, response_no: '25-B', project_id: 4, status: '対応中', inquiry_date: '2026-02-19', occurrence_date: '2026-02-19', target_area: 'パワコン', situation: '2/19アラートメールあり', response_content: '2/19清水電気が現地確認。電線焼け。\n日本エネルギー開発に対応依頼。3/12調査予定', report: '2/20大本氏へメール。2/24駆付費の承諾あり。3/2報告メール済', created_at: '2026-02-19' },
]
...
const initPeriodicMaintenance: PeriodicMaintenance[] = [
  ...
  { id: 3, project_id: 5, record_date: '2025-03-02', work_type: '除草', content: '除草実施（1回目）', created_at: '2025-03-02' },
  { id: 4, project_id: 5, record_date: '2025-09-17', work_type: '除草', content: '除草・報告書送付', created_at: '2025-09-17' },
  { id: 5, project_id: 6, record_date: '2025-03-13', work_type: '除草', content: '除草実施（1回目）', created_at: '2025-03-13' },
  { id: 6, project_id: 7, record_date: '2025-05-14', work_type: '点検', content: '架台設置および目視点検。岩壁氏へ報告。', created_at: '2025-05-14' },
]
